...
visualization <- function(chemical, samples){ # chemical is the name of the treatment
  ...
  ggsave(filename = glue('{chemical}_scatter.jpeg'), width = 16, height = 9, device='jpeg', dpi=300)
  ...
  #histo
  ggsave(filename = glue('{chemical}_hist.jpeg'), width = 16, height = 9, device='jpeg', dpi=300)
}
